...
export const internGroups = [
  {
    ...
    fields: [
      ...
      { key: 'expected_start', label: 'Thời gian bắt đầu dự kiến', label_en: 'Expected Start Date', type: 'date', required: true, apply: true },
      { key: 'expected_end', label: 'Thời gian kết thúc dự kiến', label_en: 'Expected End Date', type: 'date', required: true, apply: true },
    ],
  },
  {
